function BannerInfo() {
  return (
    <div className="flex flex-col gap-4 bg-[#f7f7f7] items-center justify-around text-center px-46 md:justify-center w-full h-[200px] md:h-[360px] lg:h-[320px]">
      <p
        style={{ fontWeight: "bold", lineHeight: "1.3" }}
        className="text-[44px] text-[#202124]"
      >
