...
export default function ChoosePlan() {
  return (
    <>
      <div className="flex flex-col gap-2 bg-[#f7f7f7] items-center justify-around text-center px-10 md:px-46 md:justify-center w-full py-4 md:py-8 md:pb-0">
        <p
          style={{ fontWeight: "bold", lineHeight: "1.3", margin: 0 }}
          className="text-[26px] md:text-[36px] text-[#202124]"
        >
          Escolha o seu plano ideal.
        </p>
        <p className="text-[16px] md:text-[17px] text-[#5f6368]">
          O Google Workspace tem o plano ideal para o seu negócio. A IA do
          Google ajuda sua equipe a ter ideias, escrever, revisar e organizar de
          forma fácil e colaborativa.
        </p>
        <p
          style={{ fontWeight: "normal", margin: 0 }}
          className="text-[18px] text-[#202124]"
        >
